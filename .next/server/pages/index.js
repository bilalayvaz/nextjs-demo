...
/* export async function getServerSideProps(context) {
  ...
  return {
    ...
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://bilalayvazoglu:kDhbzShmiUjlpxGR@cluster0.kjnb3mc.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
